webpackJsonp([6], {
    3: function (i, e, t) {
        ...
        !function (r) {
            "use strict";
            s = [t(0)], o = r, n = "function" == typeof o ? o.apply(e, s) : o, !(void 0 !== n && (i.exports = n))
        }(function (i) {
            "use strict";
            var e = window.Slick || {};
            e = function () {
                ...
                var e, t, o = this, s = this;
                if (s.options.dots === !0 && s.slideCount > s.options.slidesToShow) {
                    for (s.$slider.addClass("slick-dotted"), t = i("<ul />").addClass(s.options.dotsClass), e = 0; e <= s.getDotCount(); e += 1)t.append(i("<li />").append(s.options.customPaging.call(o, s, e)));
                    s.$dots = t.appendTo(s.options.appendDots), s.$dots.find("li").first().addClass("slick-active").attr("aria-hidden", "false")
                }
        ...
        !function () {
            t(3), $(function () {
                ...
                i.slick({
                    ...
                    arrows: !0,
                    fade: !0
                }), i.on("beforeChange", function (i, e, t, o) {
                    var s = ["c1", "c2", "c3"];
                    $("#header").addClass(s[o]).removeClass(s[t])
                })
            })
        }()
    }
