...
Datafeeds.UDFCompatibleDatafeed.prototype.calculateHistoryDepth = function (a, b, c) {
    ...
    for (var a = this, b = (this._datafeed, 0); b < this._exchangesList.length; ++b) {
        ...
        this._exchangesDataCache.hasOwnProperty(c) || (this._exchangesDataCache[c] = !0, this._exchangesWaitingForData[c] = "waiting_for_data", this._datafeed._send(this._datafeed._datafeedURL + "/symbol_info", {group: c}).done(function (b) {
            return function (c) {
