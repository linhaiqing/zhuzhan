    ...
    auiDialog.prototype = {
        ...
        create: function(params,callback) {
            ...
            if(params.input){
                ...
                if( typeof params.textType == 'undefined')
                {
                    params.textType = 'text';
                }
                var msgHtml = '<div class="aui-dialog-body"><input type="'+params.textType+'" id="aui-password" placeholder="'+params.text+'"></div>';
            }else{
            ...
            dialogHtml = '<div class="aui-dialog" style="z-index: 10001">'+headerHtml+msgHtml+footerHtml+'</div>';
        ...
        open: function(){
            ...
            if(!document.querySelector(".aui-mask")){
                var maskHtml = '<div class="aui-mask" style="z-index: 9999"></div>';
