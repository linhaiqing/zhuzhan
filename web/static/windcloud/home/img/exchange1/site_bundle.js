...
(function($) {
    ...
    $.jGrowl = function(m, o) {
        if ($('#jGrowl').length === 0) $('<div id="jGrowl"></div>').addClass((o && o.position) ? o.position : $.jGrowl.defaults.position).appendTo('body');
        $('#jGrowl').jGrowl(m, o);
    };
    ...
    $.extend($.fn.jGrowl.prototype, {
        ...
        update: function() {
            if (this.notifications.length > 0) this.render(this.notifications.shift());
...
(function($, window, undefined) {
    ...
    signalR.fn = signalR.prototype = {
        ...
        start: function(options, callback) {
            ...
            var url = "http://th.mycoin.ph/exchange/negotiate",
